    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"> Indicador de Filme </a>
            </div>
                      ...
                      <div class="panel panel-primary">
                        ...
                        <div class="panel-body body-panel">
							<?php
								...
								mysqli_query($criar_con, "delete from filme where pk_filme='$cod'") or die ("Não foi possível retornar dados do usuário!");
								
								
								 
								
								
								echo("O Filme | $nome | foi deletado com sucesso!");
							?>
